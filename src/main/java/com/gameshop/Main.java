...
public class Main {
    public static void main(String[] args) {
        ...
        inventario.verInventario(juegos, stock);
        ...
        double precioFinal = ventas.calcularPrecio(100.0, true);  // ✅ CORREGIDO
        ...
        boolean esVip = recompensas.comprobarVip(null);  // ✅ Ahora funciona con tu fix
